...
export const pageMetadata = {
  home: getMetadata({
    ...
    image: `${WEBSITE_DETAILS.URL}/images/home/logo.png`,
  }),
  ...
  tech: getMetadata({
    ...
    canonical: `${WEBSITE_DETAILS.URL}/tech`,
    keywords: [
      "WiFi technology",
    ...
    image: `${WEBSITE_DETAILS.URL}/images/tech/intro-house-image.jpg`,
  }),
  ...
  approach: getMetadata({
    ...
    canonical: `${WEBSITE_DETAILS.URL}/approach`,
    keywords: [
    ...
    image: `${WEBSITE_DETAILS.URL}/images/approach/villa-house.jpg`,
  }),
  ...
  maintenance: getMetadata({
    ...
    canonical: `${WEBSITE_DETAILS.URL}/maintenance`,
    keywords: [
      "WiFi maintenance",
      "network support",
    ...
    image: `${WEBSITE_DETAILS.URL}/images/maintenance/maintenace-hero-image.webp`,
  }),
  ...
  contact: getMetadata({
    ...
    canonical: `${WEBSITE_DETAILS.URL}/contact`,
    keywords: [
    ...
    image: `${WEBSITE_DETAILS.URL}/images/contact/hero-image.jpg`,
  }),
};
