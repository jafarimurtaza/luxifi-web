...
export const approachTableData = {
  ...
  matrix: [
    ...
    [
      ...
      { icon: <FiCheckCircle className="text-green-500" />, text: "Core Focus" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Included" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Clean Installations" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Deep Expertise" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Included" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Fully Customizable" },
      { icon: <FiCheckCircle className="text-green-500" />, text: "Home Aesthetic First" },
    ],
    // Other Providers column
    [
      { icon: <FiXCircle className="text-red-500" />, text: "Often Commercial" },
      ...
      { icon: <FiXCircle className="text-red-500" />, text: "Basic Familiarity" },
      { icon: <FiXCircle className="text-red-500" />, text: "Additional Charge" },
      { icon: <FiXCircle className="text-red-500" />, text: "Generic Settings" },
