...
const TechCard = ({ card }) => (
  ...
  >
    <div className="space-y-4 md:space-y-6">
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight text-primary">
        {card.title}
      </h2>
      <p className="text-base sm:text-xl md:text-2xl leading-relaxed font-light text-base-content">
        {card.description}
      </p>
    </div>
  </CardLayout>
...
export default function TechSection() {
  return (
    <>
      ...
      {/* Full-width bottom linear2 image - outside the constrained section */}
      <LinearRight />
