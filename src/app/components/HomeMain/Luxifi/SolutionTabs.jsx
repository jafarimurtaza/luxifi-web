    ...
    <div className="flex flex-wrap gap-2">
      {Object.entries(solutions).map(([key, solution]) => (
        <button
          ...
          className={`px-3 sm:px-4 cursor-pointer lg:px-3 py-2 lg:py-2.5 rounded-lg font-medium text-sm sm:text-base transition-all duration-75 ease-out transform ${
            activeTab === key
